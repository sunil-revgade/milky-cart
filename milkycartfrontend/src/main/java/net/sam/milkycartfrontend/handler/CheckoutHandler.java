package net.sam.milkycartfrontend.handler;
...
import net.sam.milkycartbackend.dao.CartLineDAO;
import net.sam.milkycartbackend.dao.ProductDAO;
import net.sam.milkycartbackend.dao.UserDAO;
import net.sam.milkycartbackend.dto.Address;
import net.sam.milkycartbackend.dto.Cart;
import net.sam.milkycartbackend.dto.CartLine;
import net.sam.milkycartbackend.dto.OrderDetail;
import net.sam.milkycartbackend.dto.OrderItem;
import net.sam.milkycartbackend.dto.Product;
import net.sam.milkycartbackend.dto.User;
import net.sam.milkycartfrontend.model.CheckoutModel;
import net.sam.milkycartfrontend.model.UserModel;
